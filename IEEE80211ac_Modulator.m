%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Modulation/Demodulation process for BPSK/QPSK/QAM and OFDM
% BinData: column vector
% MCS_Index: scalar, refer to IEEE 802.11ac
% sign: True: modulator; False: demodulator
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Payload_t, Payload_f] = IEEE80211ac_Modulator(BinData, MCS_Index, sign)
